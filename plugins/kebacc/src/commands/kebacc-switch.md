...
argument-hint: "-ag|-claude|-codex|-grok|-opencode [email]"
---

Run `~/.claude-tools/kebacc`, or `~/.claude-tools/kebacc.exe` on Windows. The argument names the pool (`-ag`, `-claude`, `-codex`, `-grok`, `-opencode`) and optionally an email.
