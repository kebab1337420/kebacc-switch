...
argument-hint: "-ag|-claude|-codex|-grok"
---

Run `~/.claude-tools/kebacc`, or `~/.claude-tools/kebacc.exe` on Windows. The argument names the pool (`-ag`, `-antigravity`, `-claude`, `-cc`, `-codex`, `-cx`, `-grok`, `-gk`). One pool is required.
