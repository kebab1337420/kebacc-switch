...
kebacc_own_commands() {
    case "$1" in
        antigravity)
            printf '%s\n' kebacc-add-antigravity.md kebacc-list-antigravity.md \
                kebacc-switch-antigravity.md kebacc-remove-antigravity.md \
                kebacc-auto-antigravity.md kebacc-doctor-antigravity.md \
        ...
        *)
            printf '%s\n' kebacc-add-claude.md kebacc-list-claude.md \
                ...
                kebacc-doctor.md kebacc-update.md kebacc-install-antigravity.md
            ;;
    esac
}
...
kebacc_stale_commands() {
    case "$1" in
        antigravity)
            printf '%s\n' kebacc-auto-antigravity-off.md kebacc-antigravity-add.md \
...
kebacc_installed() {
    _kb_tools=$1
    for _kb_id in claude antigravity; do
...
kebacc_sync_all_commands() {
    ...
    for _kb_name in $(kebacc_all_commands); do
        ...
        if kebacc_has claude $_kb_installed && kebacc_has antigravity $_kb_installed; then
...
kebacc_both_installed() {
    ...
    kebacc_has claude $_kb_both && kebacc_has antigravity $_kb_both
}
